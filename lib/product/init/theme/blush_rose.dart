...
class BlushRose implements CustomAppTheme {
  //Dark Theme Colors
  static const Color homeBackgroundColor = Color(0xFFE17888);
  static const Color secondaryColor = Color(0xFFAE3B8B);
  static const Color tertiaryColor = Color(0xFF1C5789);
  static const Color fourthColor = Color(0xFF341514);
